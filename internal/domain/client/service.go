...
type IService interface {
	...
	Query(ctx context.Context, query domain.DBQueryConditions) ([]Client, error)
}
...
func (s service) Query(ctx context.Context, query domain.DBQueryConditions) ([]Client, error) {
