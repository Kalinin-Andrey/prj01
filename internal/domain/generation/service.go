...
type IService interface {
	...
	Query(ctx context.Context, query domain.DBQueryConditions) ([]Generation, error)
}
...
func (s service) Query(ctx context.Context, query domain.DBQueryConditions) ([]Generation, error) {
