...
type IService interface {
	...
	Query(ctx context.Context, query domain.DBQueryConditions) ([]Order, error)
}
...
func (s service) Query(ctx context.Context, query domain.DBQueryConditions) ([]Order, error) {
