...
type IService interface {
	...
	Query(ctx context.Context, query domain.DBQueryConditions) ([]Modification, error)
}
...
func (s service) Query(ctx context.Context, query domain.DBQueryConditions) ([]Modification, error) {
